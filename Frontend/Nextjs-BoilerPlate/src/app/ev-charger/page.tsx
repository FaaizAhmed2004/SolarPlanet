    ...
    <div className="relative w-full">
      ...
      <div className="w-full flex flex-col md:flex-row">
        ...
        <button
          ...
          className={`bg-background text-center py-6 px-4 flex-1 flex flex-col items-center justify-center transition-colors ${
            activeTab === "solutions" ? "bg-background" : "bg-background hover:bg-muted/50"
          }`}
        >
          ...
          <ChevronDown className="text-primary mt-2 h-6 w-6" />
        </button>
        ...
        <button
          ...
          className={`text-center py-6 px-4 flex-1 flex items-center justify-center transition-colors ${
            activeTab === "why-choose" ? "bg-primary text-white" : "bg-accent text-white hover:bg-primary"
          }`}
        >
        ...
        <button
          ...
          className={`text-center py-6 px-4 flex-1 flex items-center justify-center transition-colors ${
            activeTab === "installation" ? "bg-accent text-white" : "bg-amber-300 text-white hover:bg-accent"
          }`}
        >
      ...
      <div className="bg-muted/50">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-foreground">Our EV Charging Solutions</h2>

            <div className="grid-2-col">
              <div className="bg-background rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-4 text-foreground">Home Charging Solutions</h3>
                ...
                <ul className="list-disc pl-5 text-readable space-y-2">
              ...
              <div className="bg-background rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-4 text-foreground">Commercial Charging Solutions</h3>
                <p className="text-readable mb-4">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-foreground">Why Choose the Tesla Wall Connector?</h2>
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-foreground">Installation & Cost</h2>

            <div className="bg-background rounded-lg shadow-md p-8 mb-8">
              <h3 className="text-2xl font-semibold mb-6 text-foreground">Installation Process</h3>

              <div className="space-content">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center flex-shrink-0 mr-4">
            ...
            <div className="bg-background rounded-lg shadow-md p-8">
              <h3 className="text-2xl font-semibold mb-6 text-foreground">Cost Breakdown</h3>

              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead>
                    <tr>
                      <th className="px-6 py-3 bg-muted/50 text-left text-xs font-medium text-subtle uppercase tracking-wider">
                        Component
                      </th>
                      <th className="px-6 py-3 bg-muted/50 text-left text-xs font-medium text-subtle uppercase tracking-wider">
                        Price Range
                  ...
                  <tbody className="bg-background divide-y divide-gray-200">
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-subtle">$500 - $1,500</td>
                      <td className="px-6 py-4 text-sm text-subtle">Varies by model and features</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">
                        Installation Labor
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-subtle">$300 - $1,000</td>
                      <td className="px-6 py-4 text-sm text-subtle">Depends on complexity and location</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">
                        Electrical Upgrades
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-subtle">$0 - $2,000</td>
                      <td className="px-6 py-4 text-sm text-subtle">If panel upgrade is required</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">
                        Permits & Inspections
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-subtle">$100 - $400</td>
                      <td className="px-6 py-4 text-sm text-subtle">Varies by location</td>
                    </tr>
                  </tbody>
                </table>
              </div>

              <p className="mt-6 text-readable">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-content">
              <div className="bg-background rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold mb-2 text-foreground">How long does it take to charge my EV?</h3>
                <p className="text-readable">
              ...
              <div className="bg-background rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold mb-2 text-foreground">Do I need to upgrade my electrical panel?</h3>
                <p className="text-readable">
