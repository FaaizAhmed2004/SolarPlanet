  ...
  return (
    <div className="page-container section-padding">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Residential Column */}
        <div>
          <h2 className="text-2xl font-bold mb-6 text-foreground">Residential</h2>
          ...
          <div className="mb-8">
            ...
            {expandedStudy === "michele" && (
              <div className="bg-muted/50 p-4 rounded-md mt-2 animate-fadeIn">
        ...
        {/* Commercial Column */}
        <div>
          <h2 className="text-2xl font-bold mb-6 text-foreground">Commercial</h2>
